...
const ConsentPage = () => {
  return (
    <div className="w-2/3 mx-auto  h-full overflow-auto">
      ...
      <h2 className="text-gray-400 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0">
        A. Správce
      </h2>
      <p className="py-5">
        Správcem osobních údajů je{" "}
        <span className="font-bold">Documex s.r.o., IČO: 19197934</span>, se
        sídlem Rybná 716/24 Praha 1, 110 00, zapsaný ve obchodním rejstříku
        vedeném Městským soudem v Praze pod sp. zn. B 26456 (dále jen „Documex“
        nebo „my“).
      </p>
      <h2 className="text-gray-400 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0">
      ...
      <div className="space-y-1 mb-3">
        <p>
          1. uzavření a plnění smlouvy se zákazníkem, abychom Vám mohli
          poskytovat objednané produkty služby, a to na na základě právního
          titulu uzavření smlouvy a kroků vedoucích k jejímu uzavření, jste-li
          její smluvní stranou, nebo na základě našeho oprávněného zájmu na
          plnění takové smlouvy, zastupujete-li zákazníka;
        </p>
        <p>
          2. vnitřních administrativních potřeb a tvorby statistik a evidencí, a
          to na základě našeho oprávněného zájmu spočívajícího zejména ve vedení
          vnitří agendy a zlepšování námi poskytovaných služeb;
        </p>
        <p>
          3. ochrany právních nároků, a to na základě našeho oprávněného zájmu
      ...
      <div className="mb-3 space-y-1">
        <p>1. identifikační údaje (např. jméno, příjmení, bydliště, IČO);</p>
        <p>
          2. kontaktní údaje (např. korespondenční a e-mailová adresa, telefonní
          číslo);
        </p>
        <p>3. údaje o využívání služeb, včetně záznamů vzájemné komunikace.</p>
      </div>
      <p className="py-5">Osobní údaje uchováváme:</p>
      <div className="mb-3 space-y-1">
        <p>
          1. pro účel dle písm. a) výše po celou dobu trvání smluvního vztahu
          zákazníkem;
        </p>
        <p>
          2. pro účely dle písm. b) a c) výše po dobu nezbytnou k realizaci práv
          a povinností plynoucích z uzavřené smlouvy a po dobu trvání promlčecí
        ...
        <p>
          3. pro účel dle písm. d) výše po dobu trvání smluvního vztahu se
          zákazníkem a dalších 12 měsíců po jeho skončení;
        </p>
        <p>
          4. pro účel dle písm. e) výše po celou dobu trvání zákonných
          povinností, zpravidla však nikoliv déle než po dobu 10 let.
        </p>
      </div>
      <h2 className="text-gray-400 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0">
      ...
      <div className="mb-3 space-y-1">
        <p>1. Poskytovatele informačních systémů a technické infrastruktury.</p>
        <p>
      ...
      <div className="mb-3 space-y-1">
        <p>
          <strong>E.1. Právo na přístup:</strong> Máte právo vědět, jaké údaje o
          Vás zpracováváme, za jakým účelem, po jakou dobu, kde Vaše osobní
          údaje získáváme, komu je předáváme, kdo je mimo nás zpracovává a jaká
          máte další práva související se zpracováním Vašich osobních údajů. To
          vše jste se dozvěděl v těchto Informacích o zpracování osobních údajů.
        ...
        <p>
          <strong>E.2. Právo na opravu:</strong> Pokud zjistíte, že osobní
        ...
        <ul>
          ...
          <p>
            ...
            omezení zpracování osobních údajů. Toto právo Vám umožňuje v
            určitých případech požadovat, aby došlo k označení Vašich osobních
            údajů a tyto údaje nebyly předmětem žádných dalších operací
            zpracování – v tomto případě však nikoliv navždy (jako v případě
        ...
        <ul>
          ...
          <p>
            ...
            Vy sám poskytl a které zpracováváme na základě plnění smlouvy. Vaše
        ...
        <ul>
          ...
          <p>
            ...
            dochází na základě našeho oprávněného zájmu. Vzhledem k tomu, že
            nejde o marketingové aktivity, přestaneme Vaše osobní údaje
        ...
        <ul>
          ...
          <p>
            Stížnost proti námi prováděnému zpracování osobních údajů můžete
            podat u Úřadu pro ochranu osobních údajů, který sídlí na adrese
            Pplk. Sochora 27, 170 00 Praha 7.
          </p>
        </ul>
        <h2 className="text-gray-400 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors mt-5">
        ...
        <div className="mb-3 space-y-1">
          <p>1. Emailem na: info@documex.cz</p>
          <p>2. Písemně na adrese: Rybná 716/24 Praha 1, 110 00</p>
        </div>
        <p className="py-5">
